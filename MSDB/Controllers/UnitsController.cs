...
namespace MSDB.Controllers
{
    public class UnitsController : Controller
    {
        ...
        public UnitsController(callme6lackContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Unit")] Units units)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Unit")] Units units)
        {
            if (id != units.Id)
            {
                return NotFound();
